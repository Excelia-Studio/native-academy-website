    ...
    <>
      ...
      >
        <nav className="max-w-[1200px] mx-auto px-6 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2 shrink-0 no-underline group" id="nav-logo">
            <motion.div
              ...
              return (
                <Link key={link.label} href={link.href} passHref legacyBehavior>
                  <motion.a
                    ...
                    className={`font-heading font-medium text-sm px-3.5 py-1.5 rounded-full transition-colors no-underline ${active
                ...
                return (
                  <Link key={item.label} href={item.href} passHref legacyBehavior>
                    <motion.a
                      ...
                      className={`font-heading font-semibold text-xl py-3.5 border-b border-gray-100 transition-colors no-underline flex items-center justify-between ${active
                        ? 'text-green-600'
