    ...
    <section className="py-12 md:py-16 bg-gray-50 border-y border-gray-100 overflow-hidden" id="direct-contact">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center max-w-[600px] mx-auto mb-12 flex flex-col items-center">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 font-heading text-[12px] tracking-[0.06em] uppercase rounded-full bg-amber-50 text-amber-700 border border-amber-200 shadow-none mb-4">
            Direct Access
          </span>
        ...
        >
          ...
          >
            <div>
              <div className="w-12 h-12 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center mb-5 group-hover:bg-amber-500 group-hover:text-white transition-colors duration-300">
